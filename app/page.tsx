    ...
    <>
     <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-background/90 mb-8 max-w-2xl mx-auto animate-fade-up animation-delay-200">
            From India's spiritual destinations to exotic international getaways — 
            customized, affordable tours for unforgettable memories.
          </p>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-float">
        <a href="#destinations" className="flex flex-col items-center gap-2 text-background/80 hover:text-background transition-colors">
