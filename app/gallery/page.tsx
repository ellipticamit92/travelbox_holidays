...
import { GalleryStats, GalleryCTA, GalleryLightbox } from "@/components/molecules";
import type { GalleryImageItemProps } from "@/components/atoms";

const galleryItems: Omit<GalleryImageItemProps, "index" | "isLiked" | "onLike" | "onClick">[] = [
    {
        id: 1,
...
const Gallery = () => {
    const [selectedImage, setSelectedImage] = useState<GalleryImageItemProps | null>(null);
